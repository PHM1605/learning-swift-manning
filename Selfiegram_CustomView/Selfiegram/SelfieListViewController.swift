...
class SelfieListViewController: UITableViewController {
    ...
    @objc func createNewSelfie() {
        ...
        // use our new CaptureView instead => find our new NavigationController
        // CaptureScene: Storyboard ID of Navigation Controller in Main file
        ...
        // if CaptureViewController applys .completion(image) => call ListViewController.newSelfieTaken(image)
        capture.completion = {
            (image: UIImage?) in
            if let image = image {
        ...
        // start NavigationController of the CaptureView screen
